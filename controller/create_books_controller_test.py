...
class TestBookController(unittest.TestCase):
    ...
    def test_create_book_success(self):
        # Teste de sucesso
        book = self.controller.create_book("The Great Gatsby", 1925, "Romance")
        self.assertIsInstance(book, BookModel)

def test_create_book_error(self):
    # Teste de erro - nome do livro inválido
    with self.assertRaises(ValueError):
        self.controller.create_book("", 1925, "Romance")

    # Teste de erro - ano do livro inválido
    with self.assertRaises(TypeError):
        self.controller.create_book("The Catcher in the Rye", "1951", "Romance")
